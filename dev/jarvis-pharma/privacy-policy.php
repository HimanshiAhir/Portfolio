...
<section class="about-section">
    <div class="about-bg-wrap">
        <div class="about-banner-content text-center">
            <h2 class="text-capitalize banner-heading mb-4">Privacy policy</h2>
            <p class="text-center about-banner-desc">By using our website, you hereby consent to our Privacy Policy and
                agree to its terms.</p>
        </div>
    </div>
</section>
<section class="about-wrap scroll-margin-top">
    <div class="si-container">
        <div class="content-wrap">
            <p class="description">At Jarvis Pharma, accessible from https://jarvispharma.co.in/, one of our main
                priorities is the privacy of our visitors. This Privacy Policy document contains types of information
                that is collected and recorded by Jarvis Pharma and how we use it.</p>
            <p class="description">If you have additional questions or require more information about our Privacy
                Policy, do not hesitate to contact us.
            </p>
            <p class="description">
                This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in Jarvis Pharma. This policy is not
        ...
        <div class="content-wrap">
            ...
            <p class="description">The personal information that you are asked to provide, and the reasons why you are
                asked to provide it, will be made clear to you at the point we ask you to provide your personal
                information.
            </p>
            <p class="description">If you contact us directly, we may receive additional information about you such as
                your name, email address, phone number, the contents of the message and/or attachments you may send us,
        ...
        <div class="content-wrap">
            ...
            <p class="description">
                Jarvis Pharma follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <div class="content-wrap">
            ...
            <p class="description">
                Like any other website, Jarvis Pharma uses 'cookies'. These cookies are used to store information
        ...
        <div class="content-wrap">
            ...
            <p class="description">
                You may consult this list to find the Privacy Policy for each of the advertising partners of Jarvis
                Pharma.
            </p>
            <p class="description">
                Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are used in their respective advertisements and links that appear on Jarvis Pharma, which are sent
            ...
            <p class="description">
                Note that Jarvis Pharma has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>
        </div>
        <div class="content-wrap">
            ...
            <p class="description">
                Jarvis Pharma's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <div class="content-wrap">
            <h2 class="content-title">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            <p class="description">
        ...
        <div class="content-wrap">
            <h2 class="content-title">GDPR Data Protection Rights</h2>
            <p class="description">
        ...
        <div class="content-wrap">
            ...
            <p class="description">Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>

            <p class="description">Jarvis Pharma does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
        </div>
</section>
